...
import { getThemes, create, getICs, getResearchApplications, assignStudent, getMyICs, getOnGoingResearch, edit, getOnlyResearch, deleteResearch, toggleCanceled } from "../controllers/scientificResearch.controller";
...
scientificResearchRoutes.delete("/:idResearch", authentication, resolver(deleteResearch));
...
scientificResearchRoutes.get("/canceled/:idResearch", authentication, resolver(toggleCanceled));
