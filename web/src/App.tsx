...
import EditScientificResearch from './pages/ScientificResearch/EditScientificResearch';
    ...
    <Router>
      <Routes>
        ...
        <Route element={<PrivateRoutes/>}>
          ...
          <Route path='/iniciacoes-cientificas/editar/:idResearch' element={<EditScientificResearch />} />
